...
public class ExcelUtils {
	...
	public static void main(String[] args) {
		...
		/*String path = "F:\\dxw\\项目文档\\北科\\数据导入\\各中心补报论文成绩";
		String[] fields = { "regNo", "name", "grade", "cname", "score" };
		String[] oFields = { "regNo", "cname", "score" };
		eu.mergeExcels(path, "F:\\dxw\\项目文档\\北科\\数据导入\\处理后数据\\毕业论文成绩（总）.xls",
				3, fields, oFields, false);*/
		// eu.divideExcels("F:\\dxw\\项目文档\\北科\\数据导入\\import_score-18-3-5导入平时成绩首钢.xls",
		// "F:\\dxw\\项目文档\\北科\\数据导入\\处理后数据\\分割\\首钢\\", 1, 1000);
		String path = "C:\\Users\\whaty\\Desktop\\1";
		String[] fields = { "问题序号", "问题描述", "12月11日", "12月12日", "12月13日", "12月14日", "12月15日", "12月16日", "12月17日", "总计" };
		eu.mergeExcels(path, "F:\\dxw\\项目文档\\北科\\数据导入\\处理后数据\\1.xls",
				2, fields, null, false);
	}
